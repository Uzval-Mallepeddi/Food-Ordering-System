...
<div class="container animated fadeIn" style="display:flex; justify-content: center; align-items: center; height: 85vh; opacity: 0.8; color: white;">
  <div class = "card" style = "background-color: black; width: 70%; padding: 20px"><br/>
    <h2 class= "text-center" style="color: white; padding-top: 14px">Signup</h2><hr style="background: white; width: 70%; margin: auto;">
      <div class = "card-body">
      	<form:form action="save" method="post" role="form" modelAttribute="user">
      		...
      		<div class = "form-group">
      			<label>Email</label>
      			<form:input type="email" class="form-control" placeholder="Enter your email address" required="required" path="email"/>
      		</div>
      		<div class = "form-group">
